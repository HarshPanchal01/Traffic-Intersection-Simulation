...
\runningtitle{Traffic Intersection Simulation} % Short title
\author{Harsh Panchal} % Full list of authors
\runningauthor{Panchal} % Short list of authors
...
\memoid{Course Project} % ID of the tech report
\theyear{2026} % year of the tech report
\mydate{March 11, 2026} %the date
